    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3 gap-y-8 md:gap-8 py-10 max-w-sm mx-auto sm:max-w-3xl lg:max-w-full">
            <div class="col-span-full mb-10 lg:col-span-2 lg:mb-0">
                <img src="{{asset('asset/img/logo-short.jpg')}}" alt="" class="w-32 h-32">
                <p class="py-8 text-sm text-gray-100 lg:max-w-xs text-center lg:text-left">Trusted in more than 100 countries & 5 million customers. Have any query ?
                   <br> k-38, keshavpuram, Awas Vikas Kalyanpur,Kanpur (U.P) 208-17
                </p>
                <a href="javascript:;"  class="py-2.5 px-5 h-9 block w-fit bg-red-600 rounded-full shadow-sm text-xs text-white mx-auto transition-all  duration-500 hover:bg-red-700 lg:mx-0">
                    Contact us
                </a>
            </div>
            <!--End Col-->
            <div class="lg:mx-auto text-left ">
                <h4 class="text-lg text-red-600 font-medium mb-7">Pagedone</h4>
                <ul class="text-sm  transition-all duration-500">
                    <li class="mb-6"><a href="javascript:;"  class="text-gray-100 hover:text-red-600">Home</a></li>
                    <li class="mb-6"><a href="javascript:;"  class=" text-gray-100 hover:text-red-600">About</a></li>
                    <li><a href="javascript:;"  class=" text-gray-100 hover:text-red-600">Pricing</a></li>
                </ul>
            </div>
            <!--End Col-->
            <div class="lg:mx-auto text-left ">
                <h4 class="text-lg text-red-600 font-medium mb-7">Products</h4>
                <ul class="text-sm  transition-all duration-500">
                    <li class="mb-6"><a href="javascript:;"  class="text-gray-100 hover:text-red-600">Figma UI System</a></li>
                    <li class="mb-6"><a href="javascript:;"  class=" text-gray-100 hover:text-red-600">Icons Assets</a></li>
                    <li><a href="javascript:;"  class=" text-gray-100 hover:text-red-600">Responsive Blocks</a></li>
                </ul>
            </div>
            <!--End Col-->
            <div class="lg:mx-auto text-left ">
                <h4 class="text-lg text-red-600 font-medium mb-7">Support</h4>
                <ul class="text-sm  transition-all duration-500">
                    <li class="mb-6"><a href="javascript:;"  class="text-gray-100 hover:text-red-600">Customer Support</a></li>
                    <li class="mb-6"><a href="javascript:;"  class=" text-gray-100 hover:text-red-600">Terms & Conditions</a></li>
                    <li ><a href="javascript:;"  class=" text-gray-100 hover:text-red-600">Privacy Policy</a></li>
                </ul>
            </div>
            <!--End Col-->
            <div class="lg:mx-auto text-left ">
                <h4 class="text-lg text-red-600 font-medium mb-7">Subscribe</h4>
                <p class="text-sm text-red-500 leading-6 mb-7">Subscribe to get the latest news from us</p>
                <a href="javascript:;"  class="flex items-center justify-center gap-2 border border-red-600 rounded-full py-3 px-6 w-fit lg:mx-0  text-sm text-red-600 font-semibold transition-all duration-500 hover:bg-red-50">Subscribe
        ...
        <div class="py-7 border-t border-gray-200">
            <div class="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
                <span class="text-sm text-red-500 ">©<a href="#">Euro</a> 2025, All rights reserved.</span>
                <div class="flex mt-4 space-x-4 sm:justify-center lg:mt-0 ">
                    <a href="javascript:;"  class="w-8 h-8 rounded-full transition-all duration-500 flex justify-center items-center bg-[#fc2323] hover:bg-gray-900">
