...
@section('content')
    ...
    <div class="max-w-full mx-auto ">
        <section id="carousel" class="relative overflow-hidden ">
            <!-- Carousel Wrapper -->
            <div class="relative h-80 md:h-[80vh]">
                <!-- Slides -->
                <div class="absolute inset-0 flex transition-opacity duration-700 ease-in-out" data-carousel-item>
                    <img src="{{ asset('https://apskhl.superhouseerp.com//Uploads/Site/APSKHL/Banner/Banner_200000001202519142336297.jpeg') }}"
                        class="object-cover w-full h-full" alt="First Slide">
                    {{-- <span class="absolute inset-0 flex items-center justify-center text-xl font-semibold text-white md:text-2xl">First Slide</span>
            --}}
                </div>
                <div class="absolute inset-0 hidden transition-opacity duration-700 ease-in-out" data-carousel-item>
                    <img src="{{ asset('https://apskhl.superhouseerp.com//Uploads/Site/APSKHL/Banner/Banner_200000001202519142659590.jpeg') }}"
                        class="object-cover w-full h-full" alt="Second Slide">
                </div>
                <div class="absolute inset-0 hidden transition-opacity duration-700 ease-in-out" data-carousel-item>
                    <img src="{{ asset('https://apskhl.superhouseerp.com//Uploads/Site/APSKHL/Banner/Banner_200000001202516135049665.jpeg') }}"
                        class="object-cover w-full h-full" alt="Third Slide">
                </div>
            </div>
            <!-- Indicators -->
            <div class="absolute bottom-5 left-1/2 flex space-x-2 -translate-x-1/2">
            ...
            <!-- Controls -->
            <button type="button"
                class="absolute top-1/2 left-3 flex items-center justify-center w-10 h-10 bg-gray-200/50 rounded-full hover:bg-gray-300 focus:outline-none transition"
                data-carousel-prev>
            ...
            <button type="button"
                class="absolute top-1/2 right-3 flex items-center justify-center w-10 h-10 bg-gray-200/50 rounded-full hover:bg-gray-300 focus:outline-none transition"
                data-carousel-next>
                <svg class="w-5 h-5 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                    xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="relative w-full max-w-5xl overflow-hidden">
            ...
            <div class="slider-container rounded-lg shadow-lg  overflow-hidden">
                <div id="slider" class="flex transition-transform duration-500 ease-in-out">
                    <div class="w-auto md:w-1/2 flex-shrink-0 p-3"><img src="{{ asset('asset/img/banner1.jpg') }}"
                            class="rounded-lg w-full shadow-md" alt="Image 1"></div>
                    <div class="w-auto md:w-1/2 flex-shrink-0 p-3"><img src="{{ asset('asset/img/banner2.jpg') }}"
                            class="rounded-lg w-full shadow-md" alt="Image 2"></div>
                    <div class="w-auto md:w-1/2 flex-shrink-0 p-3"><img src="{{ asset('asset/img/banner3.jpg') }}"
                            class="rounded-lg w-full shadow-md" alt="Image 3"></div>
                    <div class="w-auto md:w-1/2 flex-shrink-0 p-3"><img src="{{ asset('asset/img/banner1.jpg') }}"
                            class="rounded-lg w-full shadow-md" alt="Image 4"></div>
                </div>
            </div>

            <!-- Navigation Buttons -->
            <button id="prev"
                class="nav-btn absolute left-3 top-1/2 transform -translate-y-1/2 p-3 rounded-full bg-white shadow-md hover:bg-gray-300">❮</button>
            <button id="next"
    ...
    <div class=" flex items-center justify-center min-h-full py-2 relative">
        ...
        <div class="relative w-full h-96 overflow-hidden ">
            ...
            <div id="sliderWrapper" class="relative flex transition-transform duration-700 ease-in-out">
                ...
                <!-- Slide 3 -->
                <div class="relative w-full flex-shrink-0">
                    <img src="{{ asset('asset/img/banner3.jpg') }}" class="w-full h-auto object-cover">
            ...
            {{-- <div class="absolute bottom-4 left-1/2 transform -translate-x-1/2 flex space-x-2">
              ...
              <!-- Gradient Overlay -->
    <div class="absolute inset-0 bg-gradient-to-t from-black/40 via-black/40 to-black/60 h-[97%] mt-2"></div>
</div>  
    ...
    <div class="relative w-full max-w-5xl overflow-hidden">
        ...
        <div class="slider-wrapper rounded-lg shadow-lg overflow-hidden mt-4">
            <div id="imageSlider" class="flex transition-transform duration-500 ease-in-out">
                ...
                <div class="slide w-full md:w-1/2 flex-shrink-0 p-3">
                    <img src="{{ asset('asset/img/banner1.jpg') }}" class="rounded-lg w-full shadow-md" alt="Slide 4">
                </div>
            </div>
        </div>

        <!-- Navigation Buttons -->
        <button id="prevSlide" class="slider-btn absolute left-3 top-1/2 transform -translate-y-1/2 p-3 rounded-full bg-white shadow-md hover:bg-gray-300">❮</button>
        <button id="nextSlide" class="slider-btn absolute right-3 top-1/2 transform -translate-y-1/2 p-3 rounded-full bg-white shadow-md hover:bg-gray-300">❯</button>
    </div>
</div>
        ...
        <div class="relative overflow-hidden mt-6">
            <div class="flex transition-transform duration-500" id="testimonial-slider">
                <div class="w-full flex-shrink-0 text-center">
                    <img src="{{asset('https://apskhl.superhouseerp.com//Uploads/Site/APSKHL/Banner/Banner_20000000120241119114444965.jpeg')}}" class="mx-auto w-24 h-24 rounded-full border-4 border-white" alt="Parent Image">
                    <h3 class="text-lg font-semibold mt-4">Parent of Virat Malhotra - 3A</h3>
                    <p class="mt-2">Parents are very happy and satisfied with the quality education at Allenhouse. Have seen a drastic and positive change in their child. Rewarded Principal ma’am with the Amazing Principal award.</p>
                </div>
                <div class="w-full flex-shrink-0 text-center">
                    <img src="{{asset('https://apskhl.superhouseerp.com//Uploads/Site/APSKHL/Banner/Banner_20000000120241119114444965.jpeg')}}" class="mx-auto w-24 h-24 rounded-full border-4 border-white" alt="Parent Image">
                    <h3 class="text-lg font-semibold mt-4">Parent of Ayesha Sharma - 2B</h3>
                    <p class="mt-2">The school provides excellent education and focuses on overall student development. We are extremely happy with the teachers and the curriculum.</p>
                </div>
            </div>
        </div>
